      ...
      <div className="p-4 border-b space-y-4">
        <div className="relative flex items-center gap-2">
            <div className="relative w-full">
                ...
                <Input 
                  placeholder="Ask or Search here"
                ...
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
                    <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full">
                     ...
                     <Avatar className="h-8 w-8 bg-orange-500">
                        <AvatarFallback className="text-white font-bold text-sm bg-orange-500">M</AvatarFallback>
                    </Avatar>
                </div>
            </div>
        </div>
        <div className="flex items-center gap-2">
            <Button variant="secondary" className="rounded-full bg-amber-100 text-amber-800 border-amber-200 hover:bg-amber-200 h-8 px-4">
                <span className="mr-1.5">🔥</span> Sepsis protocols
            </Button>
            <Button variant="secondary" className="rounded-full bg-amber-100 text-amber-800 border-amber-200 hover:bg-amber-200 h-8 px-4">
                <span className="mr-1.5">💊</span> Drug interactions
            </Button>
        </div>
      </div>
