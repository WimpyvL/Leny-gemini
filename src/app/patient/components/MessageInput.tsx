...
export function MessageInput({ onSendMessage }: MessageInputProps) {
  ...
  return (
    <div className="flex items-center gap-3 bg-white border-2 border-slate-200 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 rounded-3xl p-2 transition-all">
      ...
      <Textarea
        ...
        className="resize-none border-0 bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 p-0 text-base max-h-36 shadow-none"
      />
