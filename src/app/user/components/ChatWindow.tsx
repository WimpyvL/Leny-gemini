...
export function ChatWindow({ conversation, currentUser, onSendMessage, allUsers, isLoading, onBack, onAddParticipantClick }: ChatWindowProps) {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-blue-50/50 via-background to-background">
      <CardHeader className="flex flex-row items-center justify-between p-4 border-b bg-gradient-to-br from-white/10 to-slate-50/10 backdrop-blur-sm shadow-sm">
        <div className="flex items-center gap-4 flex-1 overflow-hidden">
          ...
          <Avatar className="h-12 w-12">
            <AvatarImage src={!isGroupChat ? otherParticipants[0]?.avatar : undefined} alt={conversation.title} data-ai-hint="person" />
